        ...
        <div class="content">
            ...
            if(isset($_GET['1']))
            {
                if($_GET['1'] >= 0)
                {
                    ...
                    header('Location: gtest8.php#one', true, 303);
            ...
            <form action=<?php $_SERVER['PHP_SELF']?>>
                <label>1、8、2、7、3、6、4... Wie geht es weiter??</label>
                <input type="radio" name="1"  value="0">0<br>
                <input type="radio" name="1" value="12" >5<br>
                <input type="radio" name="1"  value="0">10<br>
                <input type="radio" name="1"  value="0">7<br>
